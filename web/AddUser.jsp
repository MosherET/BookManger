...
<body>
<div class="container">
    <div class="panel-heading h1 bg-success text-info">添加用户信息</div>
    <div class="panel-body">
        <div class="text-center">
            <form action="BookMangerServlet?action=UserRegister&currentPage=${page.totalPage}"  enctype="multipart/form-data" id="addUser" method="post">
                <div class="form-group">
                    <label for="uname" class="col-sm-4 control-label">真实姓名</label>
                    <div class="input-group col-sm-8">
                        <input type="text" class="form-control" id="uname" name="uname" placeholder="请输入用户的真实姓名"/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="uacount" class="col-sm-4 control-label">用户名</label>
                    <div class="input-group col-sm-8">
                        <input type="text" class="form-control" id="uacount" name="uacount" placeholder="请输入用户名"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-8">
                        <input type="text" class="form-control" id="usphone" name="usphone" placeholder="请输入手机号码"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-8 ">
                        <input type="file" id="photo" name="photo" class="form-control" value="upload/${user.touxiang}" />
                    </div>
                </div>
                <div class="form-group">
